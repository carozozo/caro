...
carol.files = (function () {
    ...
    self.readDir = function (rootPath, opt) {
        ...
        var readDir = function (path, opt, firstRootPath, levelCount) {
            if (!carol.helper.isStr(path) || path === '') return [];
            ...
            if (opt) {
                ...
                if (getFile) {
                    getByExtend = (carol.helper.isStr(opt.getByExtend)) ? opt.getByExtend : false;
                    if (getByExtend) {
        ...
        try {
            ...
            tl.object.eachObj(files, function (i, file) {
                ...
                if (self.isDir(curPath)) {
                    // recursively
                    if (carol.helper.isEmptyVal(removeByExtname)) {
                        opt.removeSelf = true;
                    }
                ...
                if (!carol.helper.isEmptyVal(keepByExtname)) {
